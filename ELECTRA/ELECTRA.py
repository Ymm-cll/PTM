...
tokenizer = paddlenlp.transformers.ElectraTokenizer.from_pretrained(name)
...
model = paddlenlp.transformers.ElectraForSequenceClassification.from_pretrained(name, num_classes=2)
