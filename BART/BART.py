...
tokenizer = paddlenlp.transformers.BartTokenizer.from_pretrained(name)
...
model = paddlenlp.transformers.BartForSequenceClassification.from_pretrained(name, num_classes=2)
