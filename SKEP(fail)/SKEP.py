...
tokenizer = paddlenlp.transformers.SkepTokenizer.from_pretrained(name)
...
model = paddlenlp.transformers.SkepForSequenceClassification.from_pretrained(name, num_classes=2)
