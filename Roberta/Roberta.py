...
tokenizer = paddlenlp.transformers.LayoutXLMTokenizer.from_pretrained(name)
...
model = paddlenlp.transformers.LayoutXLMForSequenceClassification.from_pretrained(name, num_classes=2)
